...
bool GameLayer::init()
{
	...
	_player1A->setPosition(ccp(_screenSize.width * 0.5, _player1A->radius() ));
    this->addChild(_player1A, 0, kPlayer1Tag);
	_player1B =  GameSprite::gameSpriteWithFile("mallet.png");
	_player1B->setPosition(ccp(_screenSize.width * 0.5, _player1B->radius() * 2));
    this->addChild(_player1B, 0, kPlayer1Tag);
    _player1C =  GameSprite::gameSpriteWithFile("mallet.png");
	_player1C->setPosition(ccp(_screenSize.width * 0.5, _player1C->radius() * 4));
    ...
    this->addChild(_player2A, 0, kPlayer1Tag);
	_player2B =  GameSprite::gameSpriteWithFile("mallet.png");
	_player2B->setPosition(ccp(_screenSize.width * 0.5, _player2B->radius() * 2));
    this->addChild(_player2B, 0, kPlayer1Tag);
    _player2C =  GameSprite::gameSpriteWithFile("mallet.png");
	_player2C->setPosition(ccp(_screenSize.width * 0.5, _player2C->radius() * 4));
    this->addChild(_player2C, 0, kPlayer1Tag);
